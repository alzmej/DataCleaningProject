...
```
git clone https://github.com/alzmej/DataCleaningProject
```
...
* [Алексей Титаренко](https://vk.com/id211993897)

## Выводы

Реализовано несколько простых функций по очистке данных, которые достаточно эффективно подготовили тестовый датасет к обучени модели.